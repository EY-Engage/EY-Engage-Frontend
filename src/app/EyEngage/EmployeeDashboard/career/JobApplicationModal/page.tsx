        ...
        >
            ...
            {step === 2 && (
              ...
              >
                ...
                <div className="card-ey p-4 text-left">
                  ...
                  <p className="text-ey-sm text-ey-gray-600 mt-1">
                    {job.department} • {job.location}
                  </p>
                  <div className="mt-3 space-y-2">
                    <div className="flex items-center gap-2">
                      <FileText size={16} className="text-ey-accent-blue" />
                      <span className="text-ey-sm">
                        <strong>CV:</strong> {resumeFile?.name}
                      </span>
                    </div>
                    <div className="flex items-center gap-2">
                      <MessageSquare size={16} className="text-ey-accent-blue" />
                      <span className="text-ey-sm">
                        <strong>Lettre:</strong> {coverLetter.length} caractères
                      </span>
                    </div>
                  </div>
                </div>
          ...
          <div className="bg-ey-light-gray px-6 py-4 flex justify-between border-t border-ey-gray-200">
            ...
            >
              ...
              {step === 2 ? "Soumettre ma candidature" : "Continuer"}
            </button>
          </div>
        </motion.div>
      </div>
